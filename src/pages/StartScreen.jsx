...
const StartScreen = () => {
    ...
    return (
        <main className="w-full flex flex-col gap-4 justify-start sm:text-center sm:items-center">
            ...
            <p className="text-xl sm:hidden text-center">Your window into the Internet of AI.</p>
            <div className="w-fit flex flex-col mt-8 mx-auto">
                ...
                >
                    <span className="md:hidden text-white">Login to Coninue</span>
